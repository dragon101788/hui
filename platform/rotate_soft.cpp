...
void rotate( image & dstPic,image &  srcPic,int angle,double ZoomX,double ZoomY,double move_x,double move_y)
{
  ...
  //  PicRotary2(dstPic,srcPic,rotaryAngle,ZoomX,ZoomY, move_x, move_y);
    ...
    void PicRotary2(const BaseImage& Dst,const BaseImage& Src,double RotaryAngle,double ZoomX,double ZoomY,double move_x,double move_y)
    {
...
inline void BilInear_Border(const BaseImage& pic,const long x_16,const long y_16,Color32* result)
{
...
void PicRotary_BilInear_CopyLine(Color32* pDstLine,long dst_border_x0,long dst_in_x0,long dst_in_x1,long dst_border_x1,
                        const BaseImage& SrcPic,long srcx0_16,long srcy0_16,long Ax_16,long Ay_16)
{
    long x;
    ...
    void PicRotaryBilInear(const BaseImage & Dst,const BaseImage& Src,double RotaryAngle,double ZoomX,double ZoomY,double move_x,double move_y)
    {
