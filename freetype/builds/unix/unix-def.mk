...
#
prefix       := /home/tt/works/hui/hui/freetype/_install
exec_prefix  := ${prefix}
...
#
REQUIRES_PRIVATE   := 
LIBS_PRIVATE       := -lz -L/usr/lib/x86_64-linux-gnu -lpng12 -lz -lm
LIBSSTATIC_CONFIG  := -lfreetype -lz -L/usr/lib/x86_64-linux-gnu -lpng12 -lz -lm
build_libtool_libs := 
ft_version         := 17.4.11
